#ifndef __vtkNek5000Reader_h
#define __vtkNek5000Reader_h
...
#include "Nek5000ReaderModule.h" // For export macro
class vtkPoints;
...
class NEK5000READER_EXPORT vtkNek5000Reader : public vtkUnstructuredGridAlgorithm
{
 public:
